...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "persp-mode" '("persp" "def-" "ido-toggle-persp-filter" "safe-persp-" "set-" "get-" "clear-window-persp" "with-persp-ido-hooks" "window-persp-set-p" "*persp-")))
